...
-(void)setFrame:(CGRect)frame
{
    ...
    UIButton *img = _toggleView;
    CGFloat y = (self.bounds.size.height - img.imageView.image.size.height)/2.0;
    img.frame = CGRectMake(30 - img.imageView.image.size.width, y, img.imageView.image.size.width, img.imageView.image.size.height);
}
